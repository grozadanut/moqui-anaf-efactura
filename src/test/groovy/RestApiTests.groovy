...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.moqui-anaf-efacturaTime
    ...
    @Unroll
    def "call moqui-anaf-efactura REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test moqui-anaf-efactura Rest API here
        // "put" | "s1/moqui-anaf-efactura/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
